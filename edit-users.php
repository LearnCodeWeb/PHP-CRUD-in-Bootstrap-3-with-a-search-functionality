...
<body>
	...
	<div class="container">
		...
		<div class="panel panel-default">
			<div class="panel-heading clearfix"><i class="fa fa-fw fa-edit"></i> <strong>Edit User</strong> <a href="browse-users.php" class="pull-right btn btn-danger btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Users</a></div>
